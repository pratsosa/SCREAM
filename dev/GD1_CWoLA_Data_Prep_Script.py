...
# %%
t = table.Table.read('/pscratch/sd/p/XXXXa/GD-1_gaia_x_decals.fits')
t
...
# %%
streamfinder = Table(fits.getdata("/pscratch/sd/p/XXXXa/general_stream_data/streamfinder_gaiadr3.fits"))
...
# %%
# temp_t.write('/pscratch/sd/p/XXXXa/GD-1_gaia_x_decals_stream_prep.fits', overwrite=True)
